...
MOTIVATIONAL_MESSAGES = [
    # Мысықтар туралы мотивация
    "Сенің мысығың сенімен бірге болғанда, экран маңызды болмайды! 🐾",
    "Мысықтар интернетте өмір сүрмейді, олар сені шынайы өмірде күтеді! 🐱",
    "Нағыз жылулық экранда емес, мысығыңның қасында! 😻",
    "Телефонды қой да, мысығыңды сипа—екеуіңе де пайдасы тиеді! 🐾",
    "Мысығыңның мияулауы – сенің демалысыңды сұрағаны! 🎶🐈",
    "Бір сәтке телефонды қойып, мысығыңның көздеріне қара—олар шынайы махаббатқа толы! 💕",
    "Мысықтай еркін бол—ғаламторға тәуелді емес, өмірден ләззат ал! 🌍🐈",
    "Мысықтар уақытты босқа өткізбейді—олар әр сәттен ләззат алады. Сен де солай жаса! 🐾",
    "Экраннан басыңды көтер—мысығың сені шынайы әлемде күтеді! 😺",
    "Мысығың сенен тек көңіл бөлуді күтеді—оған уақыт тап! 🐾",
    
    # Жалпы мотивациялық хабарламалар
    "Өмір—бұл қазір болып жатқан сәт. Оны бағала! 🌟",
    "Армандарды кейінге қалдырма, бүгін алғашқы қадамыңды жаса! 🚀",
    "Табыс—әр күнгі кішкентай жетістіктердің нәтижесі. 💪",
    "Ең бастысы—тоқтап қалмау. Бүгін бір қадам жаса, ертең тағы біреуін! 🔥",
    "Өзіңе сен—сен ойлағаннан да мықтысың! 💪",
    "Жеңіліс—сәтсіздік емес, бұл тек жаңа бастаманың мүмкіндігі. 🌱",
    "Бүгінгі әрекетің—ертеңгі жетістіктеріңнің негізі! ⚡️",
    "Әр күн—жаңа мүмкіндік. Оны жіберіп алма! ☀️",
    "Қателік жасаудан қорықпа—олар саған өсуге көмектеседі! 🌿",
    "Өмірде бәрі мүмкін—ең бастысы сенім мен талпыныс! 🚀"
]
